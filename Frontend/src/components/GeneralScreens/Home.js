      ...
      {loading ?
        ...
        <div>
          <div className="story-card-wrapper">
            ...
            <img className="bg-planet-svg" src="Nutch.svg" alt="planet" />
            <img className="bg-planet2-svg" src="Nutch.svg" alt="planet" />
            <img className="bg-planet3-svg" src="Nutch.svg" alt="planet" />
